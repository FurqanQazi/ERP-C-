<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseView.aspx.cs" Inherits="ERPproject.PurchaseView" %>
...
<body background="MyImages/Background.jpg">
    <form id="form1" runat="server">
        ...
        <div class="text-cons">
            <table>
                <tr>
                    ...
                    <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Vendor Code:&nbsp;&nbsp;</th>
                    <td><asp:TextBox runat="server" ID="VendorCode"></asp:TextBox><asp:Button  runat="server" ID="SearchVendorCode"  BackColor="#ffff99" Width="70px" Text="Get" OnClick="SearchVendorCode_Click"/></td>
        ...
        <div class="view">
            <asp:GridView ID="PurchaseGrd" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
