<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesView.aspx.cs" Inherits="ERPproject.SalesView" %>
    ...
    <form id="form1" runat="server">
                               ...
                               <li class="nav-item dropdown"> 
                                    ...
                                    <ul class="dropdown-menu" style="background-color:  rgba(76, 110, 115);" aria-labelledby="navbarDropdown"> 
                                        ...
                                        <li class="dropdown-item">
                                            ...
                                            <ul class="dropdown-menu dropdown-submenu" style="background-color:  rgba(76, 110, 115);">
                                                <li>
                                                   <a class="dropdown-item" href="#">Sales View</a>
                                                </li>
                                            </ul>
                                        </li>
                                   </ul>
        ...
        <div class="text-cons">
            <table>
                <tr>
                    <th>Invoice No.:&nbsp;&nbsp;</th>
                    <td><asp:TextBox runat="server" ID="InvoiceNo"></asp:TextBox></td>
                </tr>
                <tr height="100px">
        ...
        <div class="view">
            <asp:GridView ID="Salesgrd" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
