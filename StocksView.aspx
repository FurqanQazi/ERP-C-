<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StocksView.aspx.cs" Inherits="ERPproject.StocksView" %>
...
<body background="MyImages/Background.jpg">
    <form id="form1" runat="server">
                               ...
                               <li class="nav-item dropdown"> 
                                    ...
                                    <ul class="dropdown-menu" style="background-color:  rgba(76, 110, 115);" aria-labelledby="navbarDropdown"> 
                                        ...
                                        <li class="dropdown-item">
                                            ...
                                            <ul class="dropdown-menu dropdown-submenu" style="background-color:  rgba(76, 110, 115);">
                                                <li>
                                                   <a class="dropdown-item" href="#">Stocks View</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="dropdown-item">
        ...
        <div class="head1"><h1>Stock Details!</h1></div>
        <div class="err-lab">
        ...
        <div class="text-cons">
            <table>
                <tr>
                    ...
                    <th>Vendor ID:&nbsp;&nbsp;</th>
                    <td><asp:TextBox runat="server" ID="VendorID"></asp:TextBox><asp:Button  runat="server" ID="SearchVendorID"  BackColor="#ffff99" Width="70px" Text="Get" OnClick="SearchVendorID_Click"/></td>
             
                    <th> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ref No.:&nbsp;&nbsp;</th>
                    <td><asp:TextBox runat="server" ID="RefNo"></asp:TextBox><asp:Button  runat="server" ID="SearchRefNo"  BackColor="#ffff99" Width="70px" Text="Get" OnClick="SearchRefNo_Click"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
             
                    <th>BarCode :&nbsp;&nbsp;</th>
                    <td><asp:TextBox runat="server" ID="BarCode"></asp:TextBox><asp:Button  runat="server" ID="SeacrhBarCode" BackColor="#ffff99" Width="70px" Text="Get" OnClick="SeacrhBarCode_Click"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                </tr>
                <tr height="100px">
        ...
        <div class="view">
            <asp:GridView ID="StkGrid" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
